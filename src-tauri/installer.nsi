...
Function FinishShow
  ...
  IntOp $6 $6 / 96
  IntOp $7 $7 / 96
  System::Call 'user32::CreateWindowEx(i r3, w "${__NSD_CheckBox_CLASS}", w "Run on Windows startup", i ${__NSD_CheckBox_STYLE}, i r4, i r5, i r6, i r7, p r1, i0, i0, i0) i .s'
  Pop $AutoStartCheckbox
  SendMessage $HWNDPARENT ${WM_GETFONT} 0 0 $1
  SendMessage $AutoStartCheckbox ${WM_SETFONT} $1 1
  SendMessage $AutoStartCheckbox ${BM_SETCHECK} 1 0
FunctionEnd

Function FinishLeave
  SendMessage $AutoStartCheckbox ${BM_GETCHECK} 0 0 $AutoStartCheckboxState
  ${If} $AutoStartCheckboxState = 1
    Call SetRunOnStartup
  ${EndIf}
FunctionEnd
...
Function SetRunOnStartup
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Run" "Dr.Record" '"$INSTDIR\${MAINBINARYNAME}.exe" --autostart'
FunctionEnd
